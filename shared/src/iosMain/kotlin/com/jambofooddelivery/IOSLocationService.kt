...
//    }
//    @ExperimentalForeignApi
//    override suspend fun geocodeAddress(address: String): com.example.com.jambofooddelivery.utils.Result<Location> {
//        return suspendCoroutine { continuation ->
//            val geocoder = CLGeocoder()
//            geocoder.geocodeAddressString(address) { placemarks, error ->
//                if (error != null) {
//                    continuation.resume(com.example.com.jambofooddelivery.utils.Result.Error(error.localizedDescription))
//                } else {
//                    val placemark = placemarks?.firstOrNull() as? CLPlacemark
//                    val location = placemark?.location
//                    if (location != null) {
//                        location.coordinate.useContents {
//                            continuation.resume(com.example.com.jambofooddelivery.utils.Result.Success(Location(latitude, longitude)))
//                        }
//                    } else {
//                        continuation.resume(com.example.com.jambofooddelivery.utils.Result.Error("Location not found"))
//                    }
//                }
//            }
//        }
//    }
//
//    override suspend fun reverseGeocode(location: Location): com.example.com.jambofooddelivery.utils.Result<String> {
//        return suspendCoroutine { continuation ->
//            val geocoder = CLGeocoder()
...
//                        continuation.resume(com.example.com.jambofooddelivery.utils.Result.Success(addressString))
//                    } else {
